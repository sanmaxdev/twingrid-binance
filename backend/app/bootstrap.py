...
async def bootstrap():
    ...
    if not settings.BOOTSTRAP_SUPER_ADMIN_EMAIL or not settings.BOOTSTRAP_SUPER_ADMIN_PASSWORD:
        logger.warning("BOOTSTRAP_SUPER_ADMIN_EMAIL or BOOTSTRAP_SUPER_ADMIN_PASSWORD not set. Skipping bootstrap.")
        return
    ...
    async with AsyncSessionLocal() as session:
        ...
        logger.info(f"SUPER_ADMIN user '{settings.BOOTSTRAP_SUPER_ADMIN_EMAIL}' created successfully with invite code: {super_admin_invite_code}.")
